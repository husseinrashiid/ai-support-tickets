...
import { AgentTicketConversation } from "@/components/AgentTicketConversation";
import type { LeadingEntry } from "@/components/MessageThread";
      ...
      <div className="mx-auto flex max-w-[1180px] flex-col gap-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_335px]">
          <div className="flex flex-col gap-6">
            ...
            <AgentTicketConversation
              ticketId={ticket.id}
              status={ticket.status}
              viewerId={user.id}
              initialMessages={messages}
              leadingEntries={leadingEntries}
              aiInitialValue={ticket.aiSuggestedResponse ?? ""}
            />
          </div>
